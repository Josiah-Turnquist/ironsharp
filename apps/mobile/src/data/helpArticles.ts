...
export const HELP_SECTIONS: HelpSection[] = [
  {
    ...
    articles: [
      ...
      { q: "How do I switch themes?", a: "Go to Profile → Appearance. You can pick from Vesper, Parchment, Sage, Dusk, or Slate at any time." },
    ],
  },
  {
    id: "devotionals",
  ...
  },
  {
    ...
    accentPale: "#5C8FA822",
    articles: [
      { q: "How do I change my password?", a: "Go to Profile → Edit Profile → Change Password. If you signed in with Google, manage your password through your Google account." },
      { q: "How do I update my profile photo or name?", a: "Open Profile → Edit Profile to update your name and church." },
      { q: "How do I manage notifications?", a: "Profile → Notifications lets you toggle morning reminders, accountability nudges, and group activity alerts." },
  ...
  },
  {
    ...
    articles: [
      ...
      { q: "How do I upgrade or downgrade?", a: "Profile → Membership → Change Plan. Upgrades are prorated; downgrades take effect at your next renewal." },
      { q: "How do I cancel my subscription?", a: "Profile → Membership → Cancel. You keep access until the end of your billing period — no partial refunds." },
  ...
  },
  {
    ...
    articles: [
      ...
      { q: "I'm not getting notifications.", a: "Check Profile → Notifications inside IronSharp, then your device's system notification settings for IronSharp specifically." },
