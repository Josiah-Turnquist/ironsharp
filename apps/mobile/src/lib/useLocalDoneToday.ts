...
/**
 * Mirrors the reader's per-plan "locked until tomorrow" flag — which is written
 * in the device's LOCAL time on submit — so Home / Devotionals can show
 ...
 */
export function useLocalDoneToday(planId?: string, groupId?: string): boolean {
