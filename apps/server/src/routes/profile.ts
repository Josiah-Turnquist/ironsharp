...
profile.patch("/notification-prefs", async (c) => {
  ...
  const allowed = ["notifMorningReminder", "notifPartnerDone", "notifDailyNudge", "notifGroupComplete", "notifDiscipleship", "notifMailbox", "notifNudge"] as const;
